...
if(isset($_POST['Adminmodifierrdv'])){
	...
	$req=$conbd->prepare('UPDATE rendezvous SET nomRDV="'.$modifiernomRDV.'" WHERE idRDV = "'.$AdmidRDV.'"');
	$req->execute();
	$req=$conbd->prepare('UPDATE rendezvous SET prenomRDV="'.$modifierprenomRDV.'" WHERE idRDV = "'.$AdmidRDV.'"');
	$req->execute();
	$req=$conbd->prepare('UPDATE rendezvous SET telephoneRDV="'.$modifiertelRDV.'" WHERE idRDV = "'.$AdmidRDV.'"');
	$req->execute();
	$req=$conbd->prepare('UPDATE rendezvous SET mailRDV="'.$modifiermailRDV.'" WHERE idRDV = "'.$AdmidRDV.'"');
	$req->execute();
	$req=$conbd->prepare('UPDATE rendezvous SET DepartementRDV="'.$modifierDepartementRDV.'" WHERE idRDV = "'.$AdmidRDV.'"');
	$req->execute();
	$req=$conbd->prepare('UPDATE rendezvous SET sexeRDV="'.$modifiersexeRDV.'" WHERE idRDV = "'.$AdmidRDV.'"');
	$req->execute();
	$req=$conbd->prepare('UPDATE rendezvous SET siterdv="'.$modifiersiterdv.'" WHERE idRDV = "'.$AdmidRDV.'"');
	$req->execute();
	$req=$conbd->prepare('UPDATE rendezvous SET SymptomesRDV="'.$modifiersymptomesRDV.'" WHERE idRDV = "'.$AdmidRDV.'"');
	$req->execute();	
