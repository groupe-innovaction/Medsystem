...
<html lang="en">
  <head>
    ...
    <title>MEDSYSTEM | PRENDRE RENDEZ-VOUS</title>
      ...
      <div class="page-main">
	   ...
	   <div class="container">
         ...
         <div class="positionadm">
          <p> <a href="index.php"><i class="fe fe-home"> </i> Acceuil </a> <i class="fe fe-chevron-right"> </i> Prendre Rendez-vous</p>
         </div>	

			<?php
			include("../bd/connect.php");
			include("Traitement/RendezvousTraitement.php");
			?>
		     ...
		     <p>Demande De Rendez-vous</p>      
              <form class="card" method="POST" action="">
                ...
                <div class="card-footer text-center">
                  <button type="submit" name="Adminsubmitrdv" class="btn btn-primary"> <i class="fe fe-check-circle"> </i> Valider La Demande</button> 
                </div>
           </form>			 
		   </div>
		  </div>
