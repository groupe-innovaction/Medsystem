...
<html lang="en">
    ...
    <div class="page">
      <div class="page-main">
		...
		<div class="backmenu">
          ...
          $AdmidRDV=intval($_GET['idRDV']);
          }
          $req=$conbd->query('SELECT * FROM rendezvous WHERE idRDV = "'.$AdmidRDV.'" AND siterdv="'.$_SESSION['var6admin'].'"');
	   ...
	   <div class="container">
         ...
         <div class="positionadm">
          <p> <a href="index.php"><i class="fe fe-home"> </i> Acceuil </a> <i class="fe fe-chevron-right"> </i><a href="listerRendezvous.php"> Lister Rendezvous </a><i class="fe fe-chevron-right"> </i> Valider Rendez-vous</p>
         </div>	
 ...
 <div class="row">		
		<div class="col-md-12">	
		 <div class="row">    
           <div class="col-md-4">
		     <?php include("Traitement/ModifierRDV.php"); ?>
			...
			<span class="messageerreurrdv2">
              ...
              <form class="card" method="POST">
				...
				<div  id="validerrdv" class="card-footer text-center">
                  <button type="submit" name="Adminmodifierrdv" class="btn btn-primary"> <i class="fe fe-edit"> </i> Modifier</button> 
                </div>				  
                </div>
              </form>		   
		   </div> 			 
