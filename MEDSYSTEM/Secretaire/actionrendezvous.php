      ...
      <div class="page-content">
       <div class="container">
            ...
            <div class="positionadm">
              <p> <a href="index.php"><i class="fe fe-home"> </i> Acceuil </a> <i class="fe fe-chevron-right"> </i><a href="voirrendezvous.php"> Voir Rendez-vous </a><i class="fe fe-chevron-right"> </i> Valider | Annuler Rendez-vous</p>
            </div>
		...
		<div class="col-md-12">	
		 <div class="row">    
           ...
           <?php if(isset($RjouterDabord)){ echo $RjouterDabord; } ?>
            ...
            <?php include("Traitement/RajouterSEC.php"); ?>
			  <span class="messageerreurrdv2">
		    ...
		    <form class="card" method="POST">
				...
				<div  id="Rajouterrdv" class="card-footer text-center">
                  <button type="submit" name="SecRajouter" class="btn btn-primary"> <i class="fe fe-plus"> </i>Rajouter la Demande</button> 
                </div>			   
		    </form>				  
		   </div> 
		 </div> 
