      ...
      <div class="page-content">
       <div class="container">
            ...
            <div class="positionadm">
              <p> <a href="index.php"><i class="fe fe-home"> </i> Acceuil </a> <i class="fe fe-chevron-right"> </i><a href="voirrendezvous.php"> Voir Rendez-vous </a><i class="fe fe-chevron-right"> </i> Rajouter Rendez-vous</p>
            </div>
