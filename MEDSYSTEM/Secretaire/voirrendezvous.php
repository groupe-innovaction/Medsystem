                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?= $don['siterdv'] ?></td>
                          <td class="text-right">
                            <a href="actionrendezvous.php?idRDV=<?php echo $don['idRDV']; ?>" id="btnvaliderdv" class="btn btn-secondary btn-sm">Validé</a>
                          </td>
                        </tr>
						 <?php 
						 } 
                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?= $don['siterdv'] ?></td>
                          <td class="text-right">
						  <a href="actionrendezvous.php?idRDV=<?php echo $don['idRDV']; ?>" id="btnvaliderdv2" class="btn btn-secondary btn-sm">Rajoutée</a>
                          </td>
                        </tr>
						 <?php 
						 } 
